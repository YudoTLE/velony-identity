...
import { UserEmailUpdatedDomainEvent } from 'src/modules/user/domain/events/user-email-updated.domain-event';
...
export class UserEmailUpdatedEventHandler {
  ...
  handle(event: UserEmailUpdatedDomainEvent, context: EventContext): void {
